...
class NimSetup(Screen, ConfigListScreen, ServiceStopScreen):
    ...
    def createSetup(self):
        ...
        if self.nim.isCompatible('DVB-S'):
            ...
            if path.exists('/proc/stb/frontend/%d/t2mirawmode' % self.nim.slot) and config.usage.setup_level.index >= 2:
    ...
    def newConfig(self):
        self.setTextKeyBlue()
        checkList = (self.configMode,
         self.diseqcModeEntry,
         self.advancedSatsEntry,
         self.advancedLnbsEntry,
         self.advancedDiseqcMode,
         self.advancedUsalsEntry,
         self.advancedLof,
         self.advancedPowerMeasurement,
         self.turningSpeed,
         self.advancedType,
         self.advancedSCR,
         self.advancedDiction,
         self.advancedManufacturer,
         self.advancedUnicable,
         self.advancedConnected,
         self.advancedUnicableTuningAlgo,
         self.toneburst,
         self.committedDiseqcCommand,
         self.uncommittedDiseqcCommand,
         self.singleSatEntry,
         self.commandOrder,
         self.showAdditionalMotorOptions,
         self.cableScanType,
         self.terrestrialCountriesEntry,
         self.cableCountriesEntry,
         self.multiType)
...
class NimSelection(Screen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['SetupActions',
         'ColorActions',
         'MenuActions',
         'ChannelSelectEPGActions'], {'ok': self.okbuttonClick,
         'info': self.extraInfo,
         'epg': self.extraInfo,
         'cancel': self.close,
         'red': self.close,
