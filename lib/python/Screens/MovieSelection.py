...
config.movielist.useextlist = ConfigSelection(default='0', choices={'0': _('No'),
 '1': _('ServiceName'),
 '2': _('ServicePicon')})
...
class MovieSelection(Screen, HelpableScreen, SelectionEventInfo, InfoBarBase, ProtectedScreen):
    ...
    def showDeviceMounts(self):
        ...
        elif fileExists('/usr/lib/enigma2/python/Plugins/SystemPlugins/DeviceManager/plugin.pyo') or fileExists('/usr/lib/enigma2/python/Plugins/Extensions/spazeMenu/plugin.so') and not fileExists('/usr/lib/enigma2/python/Plugins/Extensions/spaTeam/plugin.pyo'):
