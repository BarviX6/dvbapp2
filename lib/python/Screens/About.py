...
class Devices(Screen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['SetupActions', 'ColorActions', 'TimerEditActions'], {'up': self['allinonedevices'].pageUp,
    ...
    def populate2(self):
        ...
        self['allinonedevices'].setText(self['TunerHeader'].getText() + '\n\n' + self['nims'].getText() + '\n\n' + self['HDDHeader'].getText() + '\n\n' + self['hdd'].getText() + '\n\n')
    ...
    def Stage1Complete(self, result, retval, extra_args = None):
        ...
        self['allinonedevices'].setText(self['allinonedevices'].getText() + self['MountsHeader'].getText() + '\n\n' + self['mounts'].getText())
