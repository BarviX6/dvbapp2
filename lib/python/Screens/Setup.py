        ...
        for x in parentNode:
            ...
            if x.tag == 'item':
                ...
                if item_tuxtxtlevel == 1 and config.usage.tuxtxt_font_and_res.value != 'expert_mode':
                    continue
                if item_tunerlevel == 1 and config.usage.frontend_priority.value not in ('expert_mode', 'experimental_mode'):
                    continue
                if item_tunerlevel == 2 and not config.usage.frontend_priority.value == 'experimental_mode':
                    continue
                if item_rectunerlevel == 1 and config.usage.recording_frontend_priority.value not in ('expert_mode', 'experimental_mode'):
                    continue
