...
class Ipkuninstall(Screen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['OkCancelActions'], {'ok': self.okPressed,
         'cancel': self.exit}, -1)
    ...
    def createMenu(self):
        ...
        self.mylist.append((_('Cams'),
         'CamSelectMenu',
         _('Delete cams previous installed.'),
         LoadPixmap(cached=True, path=resolveFilename(SCOPE_CURRENT_SKIN, 'skin_default/icons/ipkgcam.png')),
         divpng))
        self.mylist.append((_('Drivers'),
         'DriversSelectMenu',
         _('Delete drivers previous installed.'),
         LoadPixmap(cached=True, path=resolveFilename(SCOPE_CURRENT_SKIN, 'skin_default/icons/ipkgpdrivers.png')),
         divpng))
        self.mylist.append((_('Extensions'),
         'ExtSelectMenu',
         _('Delete extensions previous installed.'),
         LoadPixmap(cached=True, path=resolveFilename(SCOPE_CURRENT_SKIN, 'skin_default/icons/ipkgextensions.png')),
         divpng))
        self.mylist.append((_('SystemPlugins'),
         'SysSelectMenu',
         _('Delete systemplugins previous installed.'),
         LoadPixmap(cached=True, path=resolveFilename(SCOPE_CURRENT_SKIN, 'skin_default/icons/ipkgsystemplugins.png')),
         divpng))
        self.mylist.append((_('Skins'),
         'SkinSelectMenu',
         _('Delete skins previous installed.'),
         LoadPixmap(cached=True, path=resolveFilename(SCOPE_CURRENT_SKIN, 'skin_default/icons/ipkgskins.png')),
         None))
