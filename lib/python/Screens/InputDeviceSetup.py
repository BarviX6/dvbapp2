...
class InputDeviceSetup(Screen, ConfigListScreen):
    ...
    def __init__(self, session, device):
        ...
        self['actions'] = ActionMap(['SetupActions', 'MenuActions'], {'cancel': self.keyCancel,
         'save': self.apply,
        ...
        devicenames = [_('%s %s front panel') % (getMachineBrand(), getMachineName()),
         _('%s %s front panel') % (getMachineBrand(), getMachineName()),
         _('%s %s remote control (native)') % (getMachineBrand(), getMachineName()),
         _('%s %s advanced remote control (native)') % (getMachineBrand(), getMachineName()),
    ...
    def layoutFinished(self):
        ...
        self['config'].l.setSeperation(int(listWidth * 0.8))
