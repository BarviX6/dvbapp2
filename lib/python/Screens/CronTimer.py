...
class CronTimers(Screen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['WizardActions', 'ColorActions', 'MenuActions'], {'ok': self.info,
...
config.crontimers.runwhen = NoSave(ConfigSelection(default='Daily', choices=[('Hourly', _('Hourly')),
 ('Daily', _('Daily')),
 ('Weekly', _('Weekly')),
 ('Monthly', _('Monthly'))]))
config.crontimers.dayofweek = NoSave(ConfigSelection(default='Monday', choices=[('Monday', _('Monday')),
 ('Tuesday', _('Tuesday')),
