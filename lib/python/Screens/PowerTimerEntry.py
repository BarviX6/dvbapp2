...
class TimerEntry(Screen, ConfigListScreen):
    ...
    def createConfig(self):
        ...
        self.timerentry_afterevent = ConfigSelection(choices=[('nothing', _('do nothing')),
         ...
         ('wakeuptostandby', _('wakeup to standby')),
         ('standby', _('go to standby')),
         ('deepstandby', shutdownString)], default=afterevent)
...
class TimerLog(Screen):
    ...
    def __init__(self, session, timer):
        ...
        self['actions'] = NumberActionMap(['OkCancelActions', 'DirectionActions', 'ColorActions'], {'ok': self.keyClose,
