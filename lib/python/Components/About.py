...
def getCPUSpeedString():
    ...
    if getMachineBuild() in ('wetekplay',):
        return '1,2 GHz'
    if getMachineBuild() in ('dags72604', 'vusolo4k', 'vuultimo4k', 'vuzero4k', 'gb72604'):
        return '1,5 GHz'
    if getMachineBuild() in ('formuler1tc', 'formuler1', 'triplex', 'tiviaraplus'):
        return '1,3 GHz'
    if getMachineBuild() in ('gbmv200', 'u51', 'u52', 'u53', 'u532', 'u533', 'u54', 'u55', 'u56', 'u5', 'u5pvr', 'h9', 'h9combo', 'h10', 'cc1', 'sf8008', 'sf8008m', 'hd60', 'hd61', 'i55plus', 'ustym4kpro', 'beyonwizv2', 'viper4k', 'v8plus', 'multibox'):
        return '1,6 GHz'
...
def getCPUString():
    if getMachineBuild() in ('vuduo4k', 'osmio4k', 'osmio4kplus', 'osmini4k', 'dags72604', 'vuuno4kse', 'vuuno4k', 'vuultimo4k', 'vusolo4k', 'vuzero4k', 'hd51', 'hd52', 'sf4008', 'dm900', 'dm920', 'gb7252', 'gb72604', 'dags7252', 'vs1500', 'et1x000', 'xc7439', 'h7', '8100s', 'et13000', 'sf5008'):
        return 'Broadcom'
    if getMachineBuild() in ('gbmv200', 'u41', 'u42', 'u43', 'u51', 'u52', 'u53', 'u532', 'u533', 'u54', 'u55', 'u56', 'u5', 'u5pvr', 'h9', 'h9combo', 'h10', 'cc1', 'sf8008', 'sf8008m', 'hd60', 'hd61', 'i55plus', 'ustym4kpro', 'beyonwizv2', 'viper4k', 'v8plus', 'multibox'):
        return 'Hisilicon'
    if getMachineBuild() in ('alien5', 'wetekplay', 'wetekplay2'):
        return 'AMlogic'
    try:
        system = 'unknown'
        file = open('/proc/cpuinfo', 'r')
