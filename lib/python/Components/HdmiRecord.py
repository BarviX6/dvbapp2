...
def InitHdmiRecord():
    ...
    config.hdmirecord.framerate = ConfigSelection(choices=[('24000', '24'),
     ...
     ('30000', '30'),
     ('50000', '50'),
     ('60000', '60')], default='60000')
    config.hdmirecord.interlaced = ConfigSelection(choices=[('0', _('No')), ('1', _('Yes'))], default='0')
    config.hdmirecord.aspectratio = ConfigSelection(choices=[('0', 'Auto'), ('1', '4:3'), ('2', '16:9')], default='0')
