...
class EPGList(HTMLComponent, GUIComponent):
    ...
    def recalcEntrySize(self):
        ...
        self.dy = int((height - self.iconSize) / 2.0)
    ...
    def buildSingleEntry(self, service, eventId, beginTime, duration, EventName):
        ...
        res = [None, (eListboxPythonMultiContent.TYPE_TEXT,
          ...
          self.days[t[6]]), (eListboxPythonMultiContent.TYPE_TEXT,
          r2.x,
          r2.y,
          r2.w,
          r1.h,
    ...
    def buildMultiEntry(self, changecount, service, eventId, beginTime, duration, EventName, nowTime, service_name):
        ...
        if clock_types:
            res.append((eListboxPythonMultiContent.TYPE_TEXT,
             r1.x,
             r1.y,
             r1.w - self.space * len(clock_types),
             r1.h,
             0,
             RT_HALIGN_LEFT | RT_VALIGN_CENTER,
             service_name))
            for i in range(len(clock_types)):
                res.append((eListboxPythonMultiContent.TYPE_PIXMAP_ALPHATEST,
                 r1.x + r1.w - self.space * (i + 1),
                 r1.y + self.dy,
                 self.iconSize,
                 self.iconSize,
                 self.clocks[clock_types[len(clock_types) - 1 - i]]))
        ...
        if beginTime is not None:
            if nowTime < beginTime:
                ...
                res.extend(((eListboxPythonMultiContent.TYPE_TEXT,
                  ...
                  '%02d.%02d - %02d.%02d' % (begin[3],
                   begin[4],
                   end[3],
                   end[4])), (eListboxPythonMultiContent.TYPE_TEXT,
                  r3.x,
                  r3.y,
                  self.gap(self.tw),
                  r3.h,
                  1,
                  RT_HALIGN_RIGHT | RT_VALIGN_CENTER,
                  _('%d min') % (duration / 60)), (eListboxPythonMultiContent.TYPE_TEXT,
                  r3.x + self.tw,
                  r3.y,
                  r3.w,
                  r3.h,
                ...
                if remaining <= 0:
                    prefix = ''
                res.extend(((eListboxPythonMultiContent.TYPE_PROGRESS,
                  r2.x,
                  r2.y,
                  r2.w,
                  r2.h,
                  percent), (eListboxPythonMultiContent.TYPE_TEXT,
                  r3.x,
                  r3.y,
                  self.gap(self.tw),
                  r3.h,
                  1,
                  RT_HALIGN_RIGHT | RT_VALIGN_CENTER,
                  _('%s%d min') % (prefix, remaining)), (eListboxPythonMultiContent.TYPE_TEXT,
                  r3.x + self.tw,
                  r3.y,
                  r3.w,
                  r3.h,
