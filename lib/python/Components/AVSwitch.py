...
def InitAVSwitch():
    ...
    config.av.autores_unknownres = ConfigSelection(choices={'next': _('next higher Resolution'),
     'highest': _('highest Resolution')}, default='next')
    choicelist = []
    for i in range(5, 16):
    ...
    config.av.autores_2160p24 = ConfigSelection(choices={'2160p24': _('2160p 24Hz'),
     ...
     '2160p30': _('2160p 30Hz')}, default='2160p24')
    ...
    if have_boxmode:
        ...
        config.av.boxmode = ConfigSelection(choices={'12': _('enable PIP no HDR'),
         '1': _('12bit 4:2:0/4:2:2 no PIP')}, default='12')
