...
def InitRecordingConfig():
    ...
    config.recording.filename_composition = ConfigSelection(default='standard', choices=[('standard', _('standard')),
    ...
    config.recording.default_afterevent = ConfigSelection(choices=[('0', _('do nothing')),
     ('1', _('go to standby')),
     ('2', shutdownString),
     ('3', _('auto'))], default='3')
    config.recording.include_ait = ConfigYesNo(default=False)
    config.recording.show_rec_symbol_for_rec_types = ConfigSelection(choices=[('any', _('any recordings')),
     ('real', _('real recordings')),
     ('real_streaming', _('real recordings or streaming')),
     ('real_pseudo', _('real or pseudo recordings'))], default='real_streaming')
    config.recording.warn_box_restart_rec_types = ConfigSelection(choices=[('any', _('any recordings')),
     ('real', _('real recordings')),
     ('real_streaming', _('real recordings or streaming')),
     ('real_pseudo', _('real or pseudo recordings'))], default='real_streaming')
    config.recording.ask_to_abort_pseudo_rec = ConfigSelection(choices=[('ask', _('ask user')),
     ('abort_no_msg', _('just abort, no message')),
     ('abort_msg', _('just abort, show message')),
     ('never_abort', _('never abort'))], default='abort_msg')
    config.recording.ask_to_abort_streaming = ConfigSelection(choices=[('ask', _('ask user')),
     ('abort_no_msg', _('just abort, no message')),
     ('abort_msg', _('just abort, show message')),
     ('never_abort', _('never abort'))], default='abort_msg')
    config.recording.ask_to_abort_pip = ConfigSelection(choices=[('ask', _('ask user')),
     ('abort_no_msg', _('just abort, no message')),
     ('abort_msg', _('just abort, show message')),
     ('never_abort', _('never abort'))], default='abort_msg')
