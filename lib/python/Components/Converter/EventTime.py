...
class EventTime(Poll, Converter, object):
    ...
    def getTime(self):
        ...
        if self.type == self.TIMES:
            return (st, et)
        if self.type in (self.REMAINING,
         self.REMAINING_VFD,
         self.ELAPSED,
         self.ELAPSED_VFD):
            now = int(time())
        ...
        elif self.type in (self.NEXT_START_TIME,
         self.NEXT_END_TIME,
         self.NEXT_DURATION,
         self.THIRD_START_TIME,
         self.THIRD_END_TIME,
         self.THIRD_DURATION,
         self.NEXT_TIMES,
         self.THIRD_TIMES):
            ...
            if self.list:
                try:
                    ...
                    if self.type == self.NEXT_DURATION and self.list[1][2]:
                    ...
                    if self.type == self.NEXT_TIMES and self.list[1][1] and self.list[1][2]:
                    ...
                    if self.type == self.THIRD_DURATION and self.list[2][2]:
                    ...
                    if self.type == self.THIRD_TIMES and self.list[2][1] and self.list[2][2]:
