...
countries = {'ETSI': (ETSIClassifications(), lambda age: (_('bc%d') % age, _('Rating defined by broadcaster - %d') % age)),
        ...
        if self.type in (self.RATING, self.SRATING):
            ...
            if self.type == self.PDC:
                ...
                if pil:
                    ...
                    start = localtime(mktime([begin.tm_year,
                     (pil & 30720) >> 11,
                     (pil & 1015808) >> 15,
                     (pil & 1984) >> 6,
                     pil & 63,
                    ...
                    return _('%d.%02d. %02d:%02d') % ((pil & 1015808) >> 15,
                     (pil & 30720) >> 11,
                     (pil & 1984) >> 6,
                     pil & 63)
                ...
                try:
                    ...
                    if info:
                        ...
                        if self.list:
                            ...
                            if self.type == self.NEXT_DESCRIPTION and (self.list[1][2] or self.list[1][3]):
                            ...
                            if self.type == self.THIRD_NAME2 and self.list[2][1]:
                                return self.trimText(self.list[2][1])
                            if self.type == self.THIRD_DESCRIPTION and (self.list[2][2] or self.list[2][3]):
