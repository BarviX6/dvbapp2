...
def InitUsageConfig():
    ...
    config.usage.maxchannelnumlen = ConfigSelection(default='4', choices=[('1', _('1')),
     ('2', _('2')),
     ('3', _('3')),
     ('4', _('4')),
     ('5', _('5'))])
    ...
    config.usage.record_indicator_mode = ConfigSelection(default='3', choices=[('0', _('None')),
    ...
    config.usage.servicelist_eventprogress_view_mode = ConfigSelection(default='0_barright', choices=[('0_no', _('No')),
    ...
    config.usage.servicelist_cursor_behavior = ConfigSelection(default='keep', choices=[('standard', _('Standard')),
     ('keep', _('Keep service')),
    ...
    config.usage.show_picon_bkgrn = ConfigSelection(default='transparent', choices=[('none', _('Disabled')),
     ...
     ('grey', _('Grey'))])
    config.usage.oldstyle_zap_controls = ConfigSelection(default='standard', choices=[('standard', _('Standard')), ('neutrino', _('Neutrino')), ('openspa', _('OpenSPA'))])
    ...
    config.usage.on_short_yellow_key = ConfigSelection(default='0', choices=[('0', _('Audio Selection')),
     ('1', _('Timeshift')),
     ('2', _('Toggle Pillarbox <> Pan&Scan')),
     ('3', _('Teletext'))])
    config.usage.on_long_yellow_key = ConfigSelection(default='1', choices=[('0', _('Audio Selection')),
     ('1', _('Timeshift')),
     ('2', _('Toggle Pillarbox <> Pan&Scan')),
     ('3', _('Teletext'))])
    config.usage.show_spinner = ConfigYesNo(default=True)
    config.usage.enable_tt_caching = ConfigYesNo(default=True)
    config.usage.tuxtxt_font_and_res = ConfigSelection(default='TTF_SD', choices=[('X11_SD', _('Fixed X11 font (SD)')),
    ...
    config.usage.tuxtxt_TTFShiftY = ConfigSelection(default='2', choices=[('-9', '-9'),
     ('-8', '-8'),
     ('-7', '-7'),
     ('-6', '-6'),
     ('-5', '-5'),
     ...
     ('8', '8'),
     ('9', '9')])
    config.usage.tuxtxt_TTFShiftX = ConfigSelection(default='0', choices=[('-9', '-9'),
     ('-8', '-8'),
     ('-7', '-7'),
     ('-6', '-6'),
     ('-5', '-5'),
    ...
    config.usage.plugins_sort_mode = ConfigSelection(default='user', choices=[('a_z', _('alphabetical')), ('default', _('Default')), ('user', _('user defined'))])
    ...
    config.usage.menu_sort_mode = ConfigSelection(default='user', choices=[('a_z', _('alphabetical')), ('default', _('Default')), ('user', _('user defined'))])
    ...
    config.usage.pip_zero_button = ConfigSelection(default='standard', choices=[('standard', _('Standard')),
     ...
     ('stop', _('Stop PiP'))])
    config.usage.pip_hideOnExit = ConfigSelection(default='no', choices=[('no', _('No')), ('popup', _('With popup')), ('without popup', _('Without popup'))])
    ...
    if not os.path.exists(resolveFilename(SCOPE_HDD)):
        try:
            os.mkdir(resolveFilename(SCOPE_HDD), 493)
        except:
            pass
    ...
    if not os.path.exists(resolveFilename(SCOPE_TIMESHIFT)):
        try:
            os.mkdir(resolveFilename(SCOPE_TIMESHIFT), 493)
        except:
            pass
    ...
    if not os.path.exists(resolveFilename(SCOPE_PICON)):
        try:
            os.mkdir(resolveFilename(SCOPE_PICON), 493)
        except:
            pass
    ...
    if not os.path.exists(resolveFilename(SCOPE_AUTORECORD)):
        try:
            os.mkdir(resolveFilename(SCOPE_AUTORECORD), 493)
        except:
            pass
    ...
    config.usage.on_movie_start = ConfigSelection(default='ask yes', choices=[('ask yes', _("Ask user (with default as 'yes')")),
    ...
    choicelist = [('show_menu', _('Show shutdown menu')),
    ...
    config.usage.long_press_emulation_key = ConfigSelection(default='0', choices=[('0', _('None')),
    ...
    config.usage.show_channel_jump_in_servicelist = ConfigSelection(default='quick', choices=[('quick', _('Quick Actions')), ('alpha', _('Alpha')), ('number', _('Number'))])
    config.usage.show_event_progress_in_servicelist.addNotifier(refreshServiceList)
    config.usage.show_channel_numbers_in_servicelist.addNotifier(refreshServiceList)
    if getDisplayType() in ('7segment',):
        config.usage.blinking_display_clock_during_recording = ConfigSelection(default='Rec', choices=[('Rec', _('REC')),
    ...
    if getDisplayType() in ('textlcd',):
        config.usage.blinking_rec_symbol_during_recording = ConfigSelection(default='Channel', choices=[('Rec', _('REC Symbol')), ('RecBlink', _('Blinking REC Symbol')), ('Channel', _('Channelname'))])
    if getDisplayType() in ('7segment',):
        config.usage.blinking_rec_symbol_during_recording = ConfigSelection(default='Rec', choices=[('Rec', _('REC')), ('RecBlink', _('Blinking REC')), ('Time', _('Time'))])
    else:
        config.usage.blinking_rec_symbol_during_recording = ConfigYesNo(default=True)
    config.usage.show_in_standby = ConfigSelection(default='time', choices=[('time', _('Time')), ('nothing', _('Nothing'))])
    ...
    config.usage.swap_time_display_on_osd = ConfigSelection(default='0', choices=[('0', _('Skin Setting')),
     ('1', _('Mins')),
     ('2', _('Mins Secs')),
     ('3', _('Hours Mins')),
     ('4', _('Hours Mins Secs')),
     ('5', _('Percentage'))])
    config.usage.swap_media_time_display_on_osd = ConfigSelection(default='0', choices=[('0', _('Skin Setting')),
     ('1', _('Mins')),
     ('2', _('Mins Secs')),
     ('3', _('Hours Mins')),
     ('4', _('Hours Mins Secs')),
     ('5', _('Percentage'))])
    config.usage.swap_time_remaining_on_osd = ConfigSelection(default='0', choices=[('0', _('Remaining')),
     ('1', _('Elapsed')),
     ('2', _('Elapsed & Remaining')),
     ('3', _('Remaining & Elapsed'))])
    config.usage.elapsed_time_positive_osd = ConfigYesNo(default=False)
    config.usage.swap_time_display_on_vfd = ConfigSelection(default='0', choices=[('0', _('Skin Setting')),
     ('1', _('Mins')),
     ('2', _('Mins Secs')),
     ('3', _('Hours Mins')),
     ('4', _('Hours Mins Secs')),
     ('5', _('Percentage'))])
    config.usage.swap_media_time_display_on_vfd = ConfigSelection(default='0', choices=[('0', _('Skin Setting')),
     ('1', _('Mins')),
     ('2', _('Mins Secs')),
     ('3', _('Hours Mins')),
     ('4', _('Hours Mins Secs')),
     ('5', _('Percentage'))])
    config.usage.swap_time_remaining_on_vfd = ConfigSelection(default='0', choices=[('0', _('Remaining')),
     ('1', _('Elapsed')),
     ('2', _('Elapsed & Remaining')),
     ('3', _('Remaining & Elapsed'))])
    config.usage.elapsed_time_positive_vfd = ConfigYesNo(default=False)
    config.usage.lcd_scroll_delay = ConfigSelection(default='10000', choices=[('10000', '10 ' + _('seconds')),
     ('20000', '20 ' + _('seconds')),
     ('30000', '30 ' + _('seconds')),
     ('60000', '1 ' + _('minute')),
     ('300000', '5 ' + _('minutes')),
     ('noscrolling', _('off'))])
    config.usage.lcd_scroll_speed = ConfigSelection(default='300', choices=[('500', _('slow')), ('300', _('normal')), ('100', _('fast'))])
    ...
    config.usage.date.dayfull = ConfigSelection(default=_('%A %-d %B %Y'), choices=[(_('%A %d %B %Y'), _('Dayname DD Month Year')),
    ...
    def setDateStyles(configElement):
        dateStyles = {_('%A %d %B %Y'): (_('%a %d %B %Y'),
                            _('%a %d %b %Y'),
                            _('%A %d %B'),
                            _('%a %d %b'),
                            _('%a %d'),
    ...
    if locale.nl_langinfo(locale.AM_STR) and locale.nl_langinfo(locale.PM_STR):
        config.usage.time.long = ConfigSelection(default=_('%T'), choices=[(_('%T'), _('HH:mm:ss')),
         (_('%-H:%M:%S'), _('H:mm:ss')),
    ...
    config.usage.date.display = ConfigSelection(default=_('%-d %b'), choices=[('', _('Hidden / Blank')),
     (_('%d %b'), _('Day DD Mon')),
     (_('%-d %b'), _('Day D Mon')),
     (_('%d-%b'), _('Day DD-Mon')),
     (_('%-d-%b'), _('Day D-Mon')),
    ...
    def adjustDisplayDates():
        ...
        elif config.usage.time.wide_display.value:
    ...
    if locale.nl_langinfo(locale.AM_STR) and locale.nl_langinfo(locale.PM_STR):
        config.usage.time.display = ConfigSelection(default=_('%R'), choices=[('', _('Hidden / Blank')),
         (_('%R'), _('HH:mm')),
         (_('%-H:%M'), _('H:mm')),
    ...
    config.osd.threeDmode = ConfigSelection([('off', _('Off')),
     ('auto', _('Auto')),
    ...
    config.timeshift.favoriteSaveAction = ConfigSelection([('askuser', _('Ask user')),
     ('savetimeshift', _('Save and stop')),
     ('savetimeshiftandrecord', _('Save and record')),
     ('noSave', _("Don't save"))], 'askuser')
    ...
    config.timeshift.timeshiftCheckEvents = ConfigSelection(default='0', choices=[('0', _('Disabled')),
     '15',
     '30',
     '60',
     '120',
     '240',
     '480'])
    config.timeshift.timeshiftCheckFreeSpace = ConfigSelection(default='0', choices=[('0', _('No')),
     ('1024', _('1 GB')),
     ('2048', _('2 GB')),
     ('4096', _('4 GB')),
     ('8192', _('8 GB'))])
    ...
    config.seek.withjumps_after_ff_speed = ConfigSelection([('1', _('never')),
     ('2', _('2x')),
     ('4', _('2x, 4x')),
     ('6', _('2x, 4x, 6x')),
     ('8', _('2x, 4x, 6x, 8x'))], default='4')
    config.seek.withjumps_forwards_ms = ConfigSelection([('200', _('0.2s')),
     ('300', _('0.3s')),
     ('400', _('0.4s')),
     ('500', _('0.5s')),
     ('600', _('0.6s')),
     ...
     ('3500', _('3.5s')),
     ('4000', _('4s')),
     ('5000', _('5s'))], default='700')
    config.seek.withjumps_backwards_ms = ConfigSelection([('200', _('0.2s')),
     ('300', _('0.3s')),
     ('400', _('0.4s')),
     ('500', _('0.5s')),
     ('600', _('0.6s')),
     ...
     ('4000', _('4s')),
     ('5000', _('5s'))], default='700')
    config.seek.withjumps_repeat_ms = ConfigSelection([('200', _('0.2s')),
     ('300', _('0.3s')),
     ('400', _('0.4s')),
     ('500', _('0.5s')),
     ('600', _('0.6s')),
    ...
    config.subtitles.ttx_subtitle_colors = ConfigSelection(default='1', choices=[('0', _('original')),
     ('1', _('white')),
     ('2', _('yellow')),
     ('3', _('blue')),
     ('4', _('grey')),
    ...
    for i in range(-54000000, 54045000, 45000):
        if i == 0:
            ...
            subtitle_delay_choicelist.append(('%d' % i, _('%2.1f sec') % (i / 90000.0)))
    ...
    def autolanguagesub(configElement):
        ...
        for y in range(1, 15 if config.autolanguage.subtitle_autoselect4.value else (7 if config.autolanguage.subtitle_autoselect3.value else (4 if config.autolanguage.subtitle_autoselect2.value else (2 if config.autolanguage.subtitle_autoselect1.value else 0)))):
            choicelist.append((str(y), ', '.join([ eval('config.autolanguage.subtitle_autoselect%x.getText()' % x) for x in (y & 1,
              y & 2,
              y & 4 and 3,
              y & 8 and 4) if x ])))
    ...
    config.plisettings.Subservice = ConfigSelection(default='3', choices=[('0', _('No, show always the timer list')),
...
def patchTuxtxtConfFile(dummyConfigElement):
    ...
    for f in tuxtxt2:
        command += " ; if ! grep -q '%s' %s ; then echo '%s %d' >> %s ; fi" % (f[0],
         TUXTXT_CFG_FILE,
         f[0],
         f[1],
         TUXTXT_CFG_FILE)
